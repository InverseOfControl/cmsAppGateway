...
public class ThreeDes {
    ...
    public static void main(String[] args) throws Exception {
       /* //添加新安全算法,如果用JCE就要把它添加进去
        ...
        byte[] srcBytes = ThreeDes.decryptMode(keyBytes, ThreeDes.hex2byte("Biyu5YzU+6sxDRbmWEa3B2uUcImzDo0BuXjTlL505+/pTb+/0Oqd3ou1R6J8+9Fy3CYrM18nBDqf6wAaPgUGOg==".getBytes()));
